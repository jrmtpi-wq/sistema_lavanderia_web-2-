...
def init_db_route():
    ...
    sqls = [
        ...
        # garante coluna tempo_min na laser_equipamento se já existia com nome antigo
        ...
        # garante equipamentos laser criados
        ...
        # constraint única op+referencia
